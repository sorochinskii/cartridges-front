...
export function useFileUpload(fetchCallback) {
    ...
    const uploadingBuildings = ref(false)
    ...
    const uploadBuildingsFromCsv = async () => {
        uploadingBuildings.value = true
        try {
            await api.post('/buildings/batch/create', uploadReadyData.value)
            ...
            uploadingBuildings.value = false
        }
    }
